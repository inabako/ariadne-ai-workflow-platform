...
Copy-Item -Recurse templates\boilerplates\cloud-emulators\gcp-emulators work\<work-id>\test-environment\emulator\gcp-emulators
Copy-Item -Recurse templates\boilerplates\cloud-emulators\stripe-cli work\<work-id>\test-environment\emulator\stripe-cli
```
