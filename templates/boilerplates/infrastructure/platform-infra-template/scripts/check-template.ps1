...
$required = @(
    ...
    "variables.tf",
    "outputs.tf",
    "modules/platform_catalog/main.tf",
    "modules/docker_compose_manifest/main.tf",
    "environments/$Env/main.tf",
    "gitlab/docker-compose/compose.yaml",
    "jenkins/docker-compose/compose.yaml",
    "grafana/docker-compose/compose.yaml",
    "zabbix/docker-compose/compose.yaml",
    "integrated-platform/development-platform/compose.yaml",
    "integrated-platform/observability-platform/compose.yaml",
    "integrated-platform/full-platform/compose.yaml",
...
if ($SkipTerraform) {
    Write-Output "PLATFORM_INFRA_TEMPLATE_STATIC_OK"
    return
}
...
Write-Output "PLATFORM_INFRA_TEMPLATE_TERRAFORM_OK"
