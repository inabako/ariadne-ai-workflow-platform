...
このtemplateは Ariadne 本体の機能ではなく、Ariadne workflow が選択・コピー・検証する Infrastructure Boilerplate です。`microservice-infra-template/` とは責務を分けます。

## Responsibility

| Template | Responsibility |
| --- | --- |
| `microservice-infra-template/` | アプリケーション実行基盤、gateway runtime、port、network、observability |
...
- GitLab / Jenkins / Grafana / Zabbix の責務を `microservice-infra-template/` と混ぜない。
