...
- IaC工程でRedis、cache、session、TTL、eviction、Pub/Sub補助、middleware connection contractが対象に含まれる場合 `middleware-infra-template/` を候補にし、Redis purpose、auth、maxmemory、persistence、backup / restore、secret redaction、evidenceを確認してからコピーする。
