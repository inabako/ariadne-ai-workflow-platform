...
| `templates/boilerplates/` | `gateway-template/`, `nextjs-webapp-template/`, `pyqt-template/`, `realtime-gateway-infra-template/`, `cloud-emulators/`, `flutter/` | 新規Go gateway / Next.js webapp / PyQt GUI / realtime gateway IaC / cloud emulator / Flutter multi-platform環境をtemplateから生成するためのboilerplate置き場 |
