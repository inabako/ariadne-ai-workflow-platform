...
| RT-UT-010 | `runtime/tests/test_github_knowledge_maintenance.py` | 28 | 28 | `runtime/workflow/github_knowledge_maintenance.py` | GitHub knowledge init、operation gate、tool selection、repair/rebase detect/plan/apply/sync plan/apply/RAG candidate | GitHub情報を長期知識資産化する前のhuman gateと出力を守る |
