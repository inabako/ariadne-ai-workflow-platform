...
| RT-UT-006 | `runtime/tests/test_ctl_help.py` | 43 | 43 | `runtime/common/ctl.py`, `runtime/windows-ps1/aiwf.ps1`, `runtime/posix-bash/aiwf.sh` | `aiwfctl help`、Windows 11 PowerShell入口、Linux/WSL/macOS bash入口、`aiwfctl doctor`、`aiwfctl knowledge`、GitHub knowledge sync/rebase apply、human-gate、close-archive、env選択、検索、警告表示、Context First初期化、registry参照 | 肥大化したworkflowをCLI索引から迷わず呼べるようにする |
