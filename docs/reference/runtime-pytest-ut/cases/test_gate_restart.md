...
- 入力値:
  ...
  - source: `runtime/tests/test_gate_restart.py`
  - fixture/arg: なし
  - parameter: names=なし case=なし
  - inline input: `doctor-gate`, repair command, `status_after_restart`
...
- 入力値:
  ...
  - fixture/arg: なし
  - parameter: names=なし case=なし
  - inline input: `repair_available=True`
...
- 入力値:
  ...
  - fixture/arg: なし
  - parameter: names=なし case=なし
  - inline input: invalid `status_after_restart`
...
- 入力値:
  ...
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `workflow-selection-gate`, `human-check-required`, repair command
...
- 入力値:
  ...
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `workflow-selection-gate`, `ready`, repair command
