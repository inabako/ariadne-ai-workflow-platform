...
- 入力値:
  ...
  - inline input: `args`, `status_args`, `verify_args`, `cleanup_args`, `publish_args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:57`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:103`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:117`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:130`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:142`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:153`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:328`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:416`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:559`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:619`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:672`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:720`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:733`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:746`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:763`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:789`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:818`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:867`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:925`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:962`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:974`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:988`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:998`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1009`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1052`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1159`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1174`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1189`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1202`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1226`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: test関数内で生成される固定入力、mock入力、または一時ファイル
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1248`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `args`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1267`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
  - inline input: test関数内で生成される固定入力、mock入力、または一時ファイル
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1380`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
  - inline input: test関数内で生成される固定入力、mock入力、または一時ファイル
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1455`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
  - inline input: test関数内で生成される固定入力、mock入力、または一時ファイル
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1473`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
  - inline input: test関数内で生成される固定入力、mock入力、または一時ファイル
- Expected: Placeholder; pytest assertion defines the expected result.
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1487`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
  - inline input: test関数内で生成される固定入力、mock入力、または一時ファイル
- Expected: Placeholder; pytest assertion defines the expected result.
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1500`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1518`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: test関数内で生成される固定入力、mock入力、または一時ファイル
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1540`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1581`
  - fixture/arg: なし
  - parameter: names=なし, case=なし
  - inline input: `registry`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1620`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1754`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1800`
...
- 入力値:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1826`
  - fixture/arg: `monkeypatch` (environment / function monkeypatch), `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
  - inline input: test関数内で生成される固定入力、mock入力、または一時ファイル
...
- Input:
  - pytest node: 上記コードブロックのnode id
  - source: `runtime/tests/test_ctl_help.py:1906`
  - fixture/arg: `tmp_path` (temporary filesystem)
  - parameter: names=なし, case=なし
  - inline input: `blocked_args`, `ready_args`, `pending_args`, `apply_args`
