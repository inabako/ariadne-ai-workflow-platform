...
ARIADNEの公開license方針は `AGPL-3.0-or-later` です。release時に、著作権者、公開URL、release日、GitHub Security Advisories方針、third-party dependency licenseを確認します。
...
- release前に、GitHub Actions本番の `workflow_dispatch` 実行結果で最終確認する。
