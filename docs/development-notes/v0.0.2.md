...
```text
2026-07-21T06:15:32.692+09:00 | 8b8d3b4c | 00002 | {"component":"dispatcher","event":"dispatcher_selected","input":{},"output":{}}
```

構造は、日時、trace id、sequence、JSON payload です。JSON payload では `input` と `output` を分け、実行条件と結果を観測しやすくしました。
