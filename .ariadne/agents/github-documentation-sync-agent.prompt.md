...
Follow `.ariadne/shared/runtime-entrypoint-policy.md`. Approved sync execution belongs to `aiwfctl github-knowledge sync-apply`, not direct runtime module invocation.
