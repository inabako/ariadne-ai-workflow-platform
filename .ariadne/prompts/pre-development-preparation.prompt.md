...
- `artifact_type: rag-load-dispatch` の `work/db/ariadne-knowledge-platform/rag/retrieval/<uuid>.json` が生成されたか
- `artifact_type: rag-context-pack` の `work/db/ariadne-knowledge-platform/rag/retrieval/<uuid>.json` が生成されたか
