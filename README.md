...
| リアルタイムシステム向けIaC、または開発・CI/CD・監視platform基盤を設計、生成、検証、文書化する | `/realtime-iac` | [Realtime IaC](docs/workflows/realtime-iac.md) |
...
- リアルタイムシステム向けIaC / platform infrastructure workflow
