...
def write_chunk(
    ...
    *,
    ...
    path = repo / "work" / "db" / "ariadne-knowledge-platform" / "rag" / "chunks" / name
    ...
    payload = {
        ...
        "normalized_path": "work/db/ariadne-knowledge-platform/rag/normalized/doc-1.json",
        "chunk_index": 1,
...
def make_args(repo: Path, **overrides: object) -> argparse.Namespace:
    values: dict[str, object] = {
        ...
        "output_dir": "work/db/ariadne-knowledge-platform/rag/optimized-chunks",
...
def test_ingestion_optimizer_clean_output_empty_run_and_invalid_chunk_specimens(tmp_path: Path) -> None:
    repo = make_repo(tmp_path)
    chunks_dir = repo / "work" / "db" / "ariadne-knowledge-platform" / "rag" / "chunks"
    output_dir = repo / "work" / "db" / "ariadne-knowledge-platform" / "rag" / "optimized-chunks"
