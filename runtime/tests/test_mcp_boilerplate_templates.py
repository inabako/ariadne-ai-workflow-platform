...
def test_mcp_layered_boilerplates_have_required_template_contract() -> None:
    expected = {
        ...
        "ai-agent-runtime-template": [
            ...
            "src/local_agent_runtime/framework_adapters/__init__.py",
            "src/local_agent_runtime/framework_adapters/base.py",
            "src/local_agent_runtime/framework_adapters/langgraph.py",
            "src/local_agent_runtime/framework_adapters/crewai.py",
            "src/local_agent_runtime/framework_adapters/microsoft_agent_framework.py",
            "src/local_agent_runtime/framework_adapters/autogen_compat.py",
