...
TEMPLATE_REGISTRIES = Path("templates") / REGISTRIES_DIR_NAME
...
SOURCE_SEMANTIC_HINTS = KNOWLEDGE_SOURCE_RAG / "semantic-hints"
SEMANTIC_HINT_BACKUPS = KNOWLEDGE_SOURCE_REPO / "semantic-hints"
