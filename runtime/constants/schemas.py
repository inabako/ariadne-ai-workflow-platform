...
CTL_HELP_USAGE_SCHEMA = schema_file("ctl-help-usage")
...
E2E_TEST_PLAN_SCHEMA = schema_file("e2e-test-plan")
E2E_TEST_CONTRACT_SCHEMA = schema_file("e2e-test-contract")
E2E_TEST_REPORT_SCHEMA = schema_file("e2e-test-report")
...
IAC_APP_RUNTIME_ASSESSMENT_SCHEMA = schema_file("iac-app-runtime-assessment")
IAC_DEPLOYMENT_CONTRACT_SCHEMA = schema_file("iac-deployment-contract")
IAC_DEPLOYMENT_GAP_REPORT_SCHEMA = schema_file("iac-deployment-gap-report")
IAC_PREPARE_REPORT_SCHEMA = schema_file("iac-prepare-report")
KUBERNETES_COMPATIBILITY_ASSESSMENT_SCHEMA = schema_file("kubernetes-compatibility-assessment")
KUBERNETES_DRY_RUN_EVIDENCE_SCHEMA = schema_file("kubernetes-dry-run-evidence")
KUBERNETES_EVIDENCE_SCHEMA = schema_file("kubernetes-evidence")
KUBERNETES_GAP_REPORT_SCHEMA = schema_file("kubernetes-gap-report")
KUBERNETES_MANIFEST_GENERATION_SCHEMA = schema_file("kubernetes-manifest-generation")
...
RUNTIME_HELP_CAPABILITIES_SCHEMA = schema_file("runtime-help-capabilities")
...
WORKFLOW_DOCTOR_WARNING_SCHEMA = schema_file("workflow-doctor-warning")
