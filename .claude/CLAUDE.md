# Ariadne Claude Bridge

このファイルは、Claude Code / Claude 対応IDEから Ariadne workspace を扱うための薄い bridge です。
...
- 詳細な workflow 定義は `.ariadne/` と `.agents/skills/` から読んでください。
...
.agents/skills/        workflow skill entrypoints
